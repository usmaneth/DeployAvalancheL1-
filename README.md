...
This contract includes four functions for basic arithmetic operations. Each function emits an event logging the operation, inputs, and result, which will be useful for testing and monitoring.
